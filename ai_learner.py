...
def exit_gracefully(signum, frame):
	...
	try:
		...
		input_text = input('\nReally want to Quit? (y/n)> ').lower().lstrip()
...
# This function shows the currect statistics
def show_stats(
	...
	# prints the reward awarded, current reward and the avg reward
	...
	if flag_deliberate_attempt:
		# prints the epsilon threshold value
