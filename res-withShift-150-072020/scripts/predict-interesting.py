...
'''
Toon-Dark-Magician-0-21296502:   rank:2602 (out of 10856)            originalScore: 0.8061779141426086
./test-input/tdms_0.png

Toon-Dark-Magician-0-21296502:   rank:5084 (out of 10856)            originalScore: 0.8575448393821716
./test-input/tdms_1.png

Toon-Dark-Magician-0-21296502:   rank:690 (out of 10856)            originalScore: 0.6882043480873108
 ./test-input/tdm_1.png
...
imagePath0 = './test-input/tdm_2.png'
#imagePath0 = './test-input/tdms_1.png'
'''
...
'''
Dark-Magician-0-46986414:   rank:0 (out of 10856)        score:0.3194104565048218          numORBpts:179        originalScore: 0.6398204565048218
            ./data/cards/training/dark-magician/1.jpg

Dark-Magician-0-46986414:   rank:0 (out of 10856)        score:0.43122535852432253          numORBpts:164        originalScore: 0.7001853585243225
            ./test-input/sifted-dm_0.png
...
i = 0
for name,score,absPath,numHOGPoints,originalScore in rankList:
  if absPath.split('/')[2] == cardName:
      print('Original rank: ')
